...
//            System.out.println("예외 발생 : " + e.getMessage());  // e.getMessage() : 어떤 오류 나오는 지 알려줌
//            e.printStackTrace();  // 오류 상세내용 알려줌
//        }
    }
...
//        예외가 발생하는 메소드를 호출하는 곳에서 대신 예외처리를 하기 때문에 한 곳에서 예외를 관리할 수 있음

//        throw : 예외를 강제로 발생 시키기
//        new 키워드와 예외 클래스를 사용하여 지정한 예외를 강제로 발생 시킴
