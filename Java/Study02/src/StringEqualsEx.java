...
//    new 키워드를 사용하여 생성한 String 타입 변수
        String strVal3 = new String("김민석");
        String strVal4 = new String("김민석");
...
//    String 타입의 변수에 저장된 데이터끼리 비교 검사
        ...
        if (strVal1 == strVal3) {
            System.out.println("strVal1 과 strVal3 은 참조가 같음");
        }
        else {
            System.out.println("strVal1 과 strVal3 은 참조가 다름");
        }
...
//    String 타입 변수 strVal5에 strVal3을 저장, strVal5에 strVal3이 저장하고 있는 주소를 대입
        ...
        if (strVal3 == strVal5) {
            System.out.println("strVal3 과 strVal5 는 참조가 같음");
        }
        else {
            System.out.println("strVal3 과 strVal5 는 참조가 다름");
        }
