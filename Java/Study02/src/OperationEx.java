...
//        byte byteValue3 = byte byteValue1 + byte byteValue2; 오류남
//        byte byteValue3 = (byte)(byte byteValue1 + byte byteValue2); 오류 안남
...
//        int 타입의 데이터 / double 타입의 데이터로 연산하여 int 타입의 데이터를 double 타입으로 자동 타입 변환 후 연산함
        double doubleValue = intValue5 / 4.0;   // 4.0 double 타입
