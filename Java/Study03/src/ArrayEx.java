...
//        배열의 데이터 사용법은 js의 배열과 동일함
        ...
        double average = (double)sum / scores.length; //double 이랑 int 타입 연산 시 double로 자동 변환 되서 연산 더 정확함
...
//        2번 방식으로 배열 선언
//        int 타입으로 배열 선언, 배열명 arr1로 지정, new 키워드로 배열 타입, 크기 지정
//        배열을 생성하고 아무런 데이터를 입력하지 않으면 초기값이 저장되어 있음
//        정수타입 초기값 : 0, 실수 : 0.0, 논리형 : false
        int[] arr1 = new int[5];
