...
public class WriterEx {
    public static void main(String[] args) throws IOException {
        ...
        Writer writer = new FileWriter("D:\\Programing\\Java\\test4.txt");
...
//            write() : 한글자씩 파일에 쓰기
        ...
        writer = new FileWriter("D:\\Programing\\Java\\test4-1.txt");
...
//        write(char[]) : 지정한 char[] 에 저장된 내용을 모두 쓰기
        ...
        writer = new FileWriter("D:\\Programing\\Java\\test4-2.txt");
