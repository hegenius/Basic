...
//        FileInputStream을 사용하여 이미지 파일 열기
        fis = new FileInputStream("D:\\Programing\\forest.jpg");
//        BufferedInputStream을 사용하여 버퍼로 이미지를 읽어옴
        bis = new BufferedInputStream(fis);
//        FileOutputStream을 사용하여 쓰기를 진행할 파일 위치를 지정
        fos = new FileOutputStream("D:\\Programing\\Java\\forest1.jpg");
...
//      FileOutputStream을 사용하여 실제로 파일을 지정한 위치에 씀
        ...
        fis = new FileInputStream("D:\\Programing\\forest.jpg");
        bis = new BufferedInputStream(fis);
        fos = new FileOutputStream("D:\\Programing\\Java\\forest2.jpg");
