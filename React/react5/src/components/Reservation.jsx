    ...
    <div>
      <form onSubmit={handleSubmit}>
        <label htmlFor={'chk'} className={'form-label'}>아침 식사 여부 :
          {/* checkbox 는 value 속성 사용하지 않음, checked 속성값을 true/false 로 입력하여 사용 */}
          {/* checked 속성값을 state 객체로 관리하고 있는 변수를 사용 */}
          <input type="checkbox" checked={haveBreakfast} id={'chk'} className={'form-check-input'} onChange={e => setHaveBreakfast(e.target.checked)}/>
        </label>
