...
function HookUseMemo2() {
    ...
    // useMemo 의 의존성 배열에 포함된 변수의 값이 변경되지 않을 경우 기존에 저장된 데이터를 사용하여 화면에 출력함
    const food= useMemo(() => {
    ...
    // useEffect 의 두번째 매개변수의 의존성 배열에 등록된 변수의 데이터가 변경되면 useEffect 함수가 호출됨
    useEffect(() => {
