...
// 문제 1) 버튼 2개를 생성하고 (+, -) useState와 useEffect 를 사용하여 볼륨값을 변경하는 프로그램 작성하기
function VolumeControl() {
    ...
    return (
        <div className={'border border-2 border-dark rounded-3 m-4 p-5 d-flex justify-content-center'}>
