...
public class MemberDAO {
    ...
    public void dbClose() {
        try {
            ...
            System.out.println("데이터 베이스 연결을 종료했습니다.");
    }

//    지정한 id/pw를 가지고 있는 사용자가 있는지 여부 확인하는 메소드
//    매개변수로 사용자의 id/pw 를 전달받음
    public boolean isMember(String useId, String userPw) {
...
//        데이터베이스에 전달된 id/pw가 사용된 사용자가 있는지 count로 확인하는 sql문 생성
        ...
        try {
//            PreparedStatejment 객체 생성
            pstmt = conn.prepareStatement(sql);
//            sql 문 ? 부분에 들어갈 데이터 추가
...
//    지정한 사용자정보를 가져오는 메소드
//    매개변수로 사용자 id를 받아옴
    public MemberDTO getMemberInfo(String useId) {
