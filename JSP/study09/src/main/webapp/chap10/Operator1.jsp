...
%>
    ...
    <div class="container mt-5">
        <h3 class="mb-3">변수 선언 및 할당</h3>
<%--        EL에서는 스크립틀릿에서 선언한 변수를 사용할 수 없음 --%>
        <p>스크립틀릿에서 선언한 변수 : ${ num1 } </p>
        <p>page 영역에 저장된 변수 num2 : ${ num2 } </p>
        <p>page 영역에 저장된 변수 num3 : ${ num3 } </p>
        <p>page 영역에 저장된 변수 num4 : ${ num4 } </p>
