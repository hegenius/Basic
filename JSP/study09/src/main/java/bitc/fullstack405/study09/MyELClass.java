...
public class MyELClass {
    ...
    public static boolean isNumber(String value) {
        ...
        // char 타입의 배열을 모두 꺼내서 0 ~ 9 까지의 문자인지 확인
...
//        일반적으로 사용하는 문자열 데이터 타입인 String 은 문자열 연결 연산자인 + 로 문자열을 연결 했을 경우 실제로 2개의 문자열이 하나의 문자열로 합해지는 것이 아니라 기존의 문자열을 모두 삭제하고 새로운 길다란 문자열로 생성하여 출력
