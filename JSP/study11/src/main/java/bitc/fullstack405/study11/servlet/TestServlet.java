...
//    HttpServletRequest : 클라이언트에서 요청한 데이터를 가지고 있는 객체, JSP의 내장객체 request 와 동일함
...
//        getRequestDispatcher() : request 객체에서 제공하는 페이지 이동할 페이지를 설정하는 명령, 실제 view 페이지인 JSP파일이 있는 위치를 지정
