...
// 클라이언트에서 접속할 URL 주소 설정, 주소 URL이 .one으로 끝나는 URL 요청은 모두 FrontController 서블릿이 처리함
...
//        가져온 uri 에서 / 를 문자열의 뒤에서 부터 검색하여 몇번째 index에 있는지 확인
...
//        제어문을 사용하여 조건에 데이터를 request 영역에 저장
        ...
        req.setAttribute("commandSr", commandStr);
