...
//    View.jsp 에서 자바스크립트의 location.href를 통해서 접속했기 때문에 doGet() 호출
...
//  Pass.jsp 에서 form을 통해서 post 방식으로 접속했으므로 doPost() 호출
  @Override
