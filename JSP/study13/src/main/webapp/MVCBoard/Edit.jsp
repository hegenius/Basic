...
<main class="container mt-5">
  <section>
    <div class="row">
      <div class="col-sm">
<%--        내용을 수정하기 위해서 form 태그를 사용, file 업로드가 있기 때문에 entype 설정--%>
...
<%--        기존 첨부 파일의 정보를 전달하기 위해서 input 태그를 사용 --%>
...
<%--      사용자가 수정할 수 있는 부분은 title, content, file 3개 뿐이므로 나머지는 모두 readonly 로 설정 --%>
          <div class="row mt-3">
            <div class="col-sm">
          ...
          <div class="row mt-3">
            <div class="col-sm">
              <div class="form-floating">
                  <textarea class="form-control" name="content" id="content" rows="5" placeholder="내용을 입력하세요" style="height: 200px">${board.content}</textarea>
