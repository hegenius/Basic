...
<body>
    <div class="container mt-5">
        ...
        <%
            ...
            // 쿠키에 한글을 저장 시 오류가 발생하기 때문에 URLEncoder 를 사용하여 저장
            Cookie cookie = new Cookie("myCookie", URLEncoder.encode("쿠키 맛있어요", "UTF-8"));
            cookie.setPath(request.getContextPath()); // 사이트 주소
