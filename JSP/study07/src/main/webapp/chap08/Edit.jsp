...
<%--                        input 태그의 수정을 막기 위해서 readonly과 disabled 두가지 속성을 사용 할 수 있음 --%>
...
<%--                        input 태그의 value 속성을 수정하지 않고 서버로 전달 시 readonly 를 사용해야 함 --%>
            ...
            <div class="row my-3">
                ...
                <div class="col-sm d-flex justify-content-end">
                    ...
                    <button type="reset" class="btn btn-secondary ms-2" id="btn-cancel">취 소</button>
                </div>
            </div>
        </form>
    </section>
