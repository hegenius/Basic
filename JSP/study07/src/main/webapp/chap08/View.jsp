...
<head>
    ...
    <script>
        // $(document).ready : jquery 에서 제공하는 html 태그가 모두 로드되고 난 후 아래의 자바스크립트를 실행하는 이벤트
        ...
        $(document).ready(function (){
            ...
            $('#btn-list').on("click", function(){
                // 자바스크립트에서 제공하는 페이지 이동 명령, html의 a 태그와 같음 (리다이렉트)
                location.href = "List.jsp";
            });

            // 수정 버튼 클릭
            $('#btn-edit').on("click", function(){
                // val() : jquery에서 제공하는 input 태그의 value 속성값을 설정하거나 가져오는 함수
            ...
            $('#btn-delete').on("click", function(){
                ...
                if (confirmed == true) {
                    ...
                    var frm = $("#frm")[0];
                    // action : jquery를 사용하여 선택한 form 태그의 action 속성값을 변경
    ...
    <section>
        <form id="frm" method="post">
            <div class="row my-3">
                <div class="col-sm">
                    <div class="input-group">
                        <span class="input-group-text caption1" style="width:150px">번호</span>
                        <input type="text" class="form-control" id="num" name="num" readonly value="<%=board.getNum()%>">
                    </div>
                </div>
                <div class="col-sm">
                    <div class="input-group">
                        <span class="input-group-text caption1" style="width:150px">작성자</span>
            ...
            <div class="row my-3">
                <div class="col-sm">
                    <div class="input-group">
                        <span class="input-group-text caption1" style="width:150px">작성일</span>
                        <input type="text" class="form-control" readonly value="<%=board.getPostDate()%>">
                    </div>
                </div>
                <div class="col-sm">
                    <div class="input-group">
                        <span class="input-group-text caption2" style="width:150px">조회수</span>
            ...
            <div class="row my-3">
                <div class="col-sm">
                    <div class="input-group">
                        <span class="input-group-text caption2" style="width:150px">제목</span>
            ...
            <div class="row my-3">
                <div class="col-sm">
                    <div class="input-group">
                        <span class="input-group-text caption2" style="width:150px">내용</span>
